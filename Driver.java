...
public class Driver{
    ...
    public static void main(String[] args){
        ...
        Mastermind game = new Mastermind(new GameConfiguration()); // begin a new game object, or an actual game instance with the default configs
        ...
        // (2) set up game bank + inside logic (Mastermind.java + Feedback.java)
